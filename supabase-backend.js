(() => {
  ...
  window.FVCloud={client,auth:client.auth,profile,loadData,saveData,upsertContent,deleteContent,updateRequest,deleteRequest,savePrayer,saveSettings,uploadImage,deleteImage,restoreData,resetCloud,isReady:true};
})();
